...
<body class="bg-gray-50 min-h-screen flex flex-col font-sans">
  ...
  <main class="flex-grow max-w-7xl mx-auto px-6 py-8">
    ...
    <div class="mb-8 text-center">
      <a href="../client/index.php" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg mr-4">
        Switch to Client View
      </a>
      <a href="index.php" class="bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg">
