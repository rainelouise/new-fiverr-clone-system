...
class User extends Database {
     ...
     */
    public function registerUser($username, $email, $password, $contact_number, $is_client = 1, $is_fiverr_administrator = 0) {
    ...
    /**
     * Checks if the logged-in user is an admin (legacy method for backward compatibility).
     * @return bool
     */
