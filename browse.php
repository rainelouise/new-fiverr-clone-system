...
if ($category_id) {
    ...
    if ($subcategory_id) {
        ...
        $proposals = $proposalObj->executeQuery($sql, [$category_id, $subcategory_id]);
    } else {
        ...
        $sql = "SELECT p.*, u.*, c.category_name, s.subcategory_name,
                ...
                WHERE p.category_id = ?
                ORDER BY p.date_added DESC";
        $proposals = $proposalObj->executeQuery($sql, [$category_id]);
    }
}
...
<head>
  ...
  <title><?php echo $category ? htmlspecialchars($category['category_name']) : 'Browse Categories'; ?> - Fiverr Clone</title>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
          ...
          <div class="space-y-2">
            ...
            <div>
              ...
              <?php if ($category_id == $cat['category_id']): ?>
            ...
            <div class="p-6">
              <div class="flex items-center justify-between mb-2">
                <h3 class="text-lg font-semibold text-gray-800">
                  <a href="client/other_profile_view.php?user_id=<?php echo $proposal['user_id']; ?>"
              ...
              <div class="flex items-center justify-between">
                ...
                <a href="client/login.php" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded text-sm">
                  View Details
                </a>
              </div>
            </div>
  ...
  <footer class="bg-gray-900 text-gray-300 mt-10">
    <div class="max-w-7xl mx-auto px-6 py-10 grid md:grid-cols-4 gap-8">
      <div>
        ...
        <ul class="space-y-2">
          <?php foreach ($all_categories as $cat): ?>
          <li><a href="browse.php?category=<?php echo $cat['category_id']; ?>" class="hover:text-white"><?php echo htmlspecialchars($cat['category_name']); ?></a></li>
          <?php endforeach; ?>
        </ul>
      </div>
      <div>
